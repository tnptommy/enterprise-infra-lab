...
```
No Filebeat is actually pointed at port 5044 yet — this pipeline sits ready and idle until [`17`](./17-agent-deployment-all-vms.md) configures WEB01's Filebeat output to ship here, fulfilling the integration [`08-web01-suricata-nids.md`](./08-web01-suricata-nids.md) originally noted as a forward pointer.
